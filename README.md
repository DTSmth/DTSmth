...
- 🔭 I’m currently working on A fullstack application to match open clients/shirt with candidates. Check it out [here](https://care-rust-244230612831.us-east1.run.app/)
...
> **Specialized in:** Table Design, E/R Diagrams, and JDBC
...
[![My Skills](https://skillicons.dev/icons?i=java,spring,js,ts,react,vue,html,css,rust,py,postgres,git,idea,postman)](https://skillicons.dev)
